...
# 実装ページ
  <p>No1.トップページ</p>
  <p>No2.トップページ_新規投稿ベストショットの一覧ページ</p>
  <p>No3.ユーザーログインページ</p>
  <p>No4.ユーザー新規登録ページ</p>
  <p>No5.キーワード検索の結果ページ</p>
  <p>No6.カテゴリー検索の結果ページ</p>
  <p>No7.エリアページ(6エリア分)</p>
  <p>No8.エリア検索の結果ページ</p>
  <p>No9.施設詳細ページ(281施設分)</p>
  <p>No10.施設詳細ページ_新規投稿レビューの一覧ページ</p>
  <p>No11.施設詳細ページ_新規投稿ベストショットの一覧ページ</p>
  <p>No12.ベストショット詳細ページ</p>
  <p>No13.レビューの新規投稿ページ</p>
  <p>No14.ベストショットの新規投稿ページ</p>
  <p>No15.マイページ</p>
  <p>No16.ユーザーページ</p>
  <p>No17.お気に入り施設の一覧ページ</p>
  <p>No18.いいねベストショットの一覧ページ</p>
  <p>No19.マイページ・ユーザーページ_新規投稿レビューの一覧ページ</p>
  <p>No20.マイページ・ユーザーページ_新規投稿ベストショットの一覧ページ</p>
  <p>No21.ユーザー情報の編集削除ページ</p>
  <p>No22.レビュー情報の編集削除ページ</p>
  <p>No23.ベストショット情報の編集削除ページ</p>
...
# 開発環境・使用技術
  ...
  ## コードテスト RSpec
   <p>Model Spec - モデルのバリデーションを検証する。</p> 
   <p>Request Spec - リクエストによるページ表示を検証する。</p>
   <p>System Spec - ブラウザ上での動作を検証する。</p>
