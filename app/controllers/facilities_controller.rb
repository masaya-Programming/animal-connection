class FacilitiesController < ApplicationController
  ...
  def hokkaidotohoku
    @facility = Facility.where(region_id: "1")

    @hokkaido = Facility.where(prefectures_id: "1")
    ...
    @aomori = Facility.where(prefectures_id: "2")
    ...
    @iwate = Facility.where(prefectures_id: "3")
    ...
    @miyagi = Facility.where(prefectures_id: "4")
    ...
    @akita = Facility.where(prefectures_id: "5")
    ...
    @yamagata = Facility.where(prefectures_id: "6")
    ...
    @fukushima = Facility.where(prefectures_id: "7")
  ...
  def kanto
    @facility = Facility.where(region_id: "2")

    @ibaraki = Facility.where(prefectures_id: "8")
    ...
    @tochigi = Facility.where(prefectures_id: "9")
    ...
    @gunma = Facility.where(prefectures_id: "10")
    ...
    @saitama = Facility.where(prefectures_id: "11")
    ...
    @chiba = Facility.where(prefectures_id: "12")
    ...
    @tokyo = Facility.where(prefectures_id: "13")
    ...
    @kanagawa = Facility.where(prefectures_id: "14")
  ...
  def chubu
    @facility = Facility.where(region_id: "3")

    @niigata = Facility.where(prefectures_id: "15")
    ...
    @toyama = Facility.where(prefectures_id: "16")
    ...
    @ishikawa = Facility.where(prefectures_id: "17")
    ...
    @fukui = Facility.where(prefectures_id: "18")
    ...
    @yamanashi = Facility.where(prefectures_id: "19")
    ...
    @nagano = Facility.where(prefectures_id: "20")
    ...
    @gifu = Facility.where(prefectures_id: "21")
    ...
    @shizuoka = Facility.where(prefectures_id: "22")
    ...
    @aichi = Facility.where(prefectures_id: "23")
  ...
  def kinki
    @facility = Facility.where(region_id: "4")

    @mie = Facility.where(prefectures_id: "24")
    ...
    @shiga = Facility.where(prefectures_id: "25")
    ...
    @kyoto = Facility.where(prefectures_id: "26")
    ...
    @osaka = Facility.where(prefectures_id: "27")
    ...
    @hyogo = Facility.where(prefectures_id: "28")
    ...
    @nara = Facility.where(prefectures_id: "29")
    ...
    @wakayama = Facility.where(prefectures_id: "30")
  ...
  def chugokushikoku
    @facility = Facility.where(region_id: "5")

    @tottori = Facility.where(prefectures_id: "31")
    ...
    @shimane = Facility.where(prefectures_id: "32")
    ...
    @okayama = Facility.where(prefectures_id: "33")
    ...
    @hiroshima = Facility.where(prefectures_id: "34")
    ...
    @yamaguchi = Facility.where(prefectures_id: "35")
    ...
    @tokushima = Facility.where(prefectures_id: "36")
    ...
    @kagawa = Facility.where(prefectures_id: "37")
    ...
    @ehime = Facility.where(prefectures_id: "38")
    ...
    @kochi = Facility.where(prefectures_id: "39")
  ...
  def kyushuokinawa
    @facility = Facility.where(region_id: "6")

    @fukuoka = Facility.where(prefectures_id: "40")
    ...
    @saga = Facility.where(prefectures_id: "41")
    ...
    @nagasaki = Facility.where(prefectures_id: "42")
    ...
    @kumamoto = Facility.where(prefectures_id: "43")
    ...
    @oita = Facility.where(prefectures_id: "44")
    ...
    @miyazaki = Facility.where(prefectures_id: "45")
    ...
    @kagoshima = Facility.where(prefectures_id: "46")
    ...
    @okinawa = Facility.where(prefectures_id: "47")
